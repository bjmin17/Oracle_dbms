...
-- 5.7 이하에서 이 옵션을 넣어줘야함.charset= utf8mb4
...
-- VARCHAR(3)은 가변문자로 한글이든 영어든 숫자든 3글자를 입력할 수 있음
...
-- mysql에서 현재 database schema가 어떤 encoding인지 확인하기 위해서
SHOW SESSION VARIABLES LIKE 'collation_connection'; -- collation_connection	utf8mb4_0900_ai_ci 라고 보여줌

-- mysql 5.x 이하에서는 UTF8과 latin1 방식으로 설정되어
-- 많은 문제를 일으켰다.
-- mysql 5.x 이하의 UTF8은 3byte 방식으로 가변문자열로
