...
-- 초기 크기는 10MByte로 하고 용량이 부족하면 10KB씩 용량을 확장하라.
...
-- 생성한 user2_DB 테이블 스페이스에 데이터를 관리(조작)할 사용자 계정을 생성한다.
...
-- 그 데이터들은 오라클DBMS의 SYSTEM 영역에 저장을 해 버린다.
...
-- DDL 명령을 활용하여 자신의 영역에 TABLE 등 DB Object 들을 생성, 삭제, 변경할 수 있는 권한
